...
export default function Navbar() {
  ...
  return (
    <>
      {/* Top Nav */}
      <nav className="w-full bg-linkedin dark:bg-black text-white px-6 md:px-16 py-5 flex justify-between items-center border-b border-white/10 z-50 sticky top-0 backdrop-blur-sm bg-linkedin/95 dark:bg-black/95">
        {/* Logo */}
